...
(function () {
    var console = unsafeWindow.console,
        ...
        modalContent = '<h1>So wird das nichts!</h1>'
            + '<img src="https://github.com/schwarzben/instabook/raw/release-modal-nyro/img/ll-modal-image.png">'
        ...
        modalCSS = '.ll-modal-cont{width:540px;height:250px;padding:25px 10px;font-size:1.3333em}'
            + '.ll-modal-cont h1{color:#3b5998;font-size:1.5em}'
            + '.ll-modal-cont img{display:block;float:right;margin: 1em 0 1em 1em}',
